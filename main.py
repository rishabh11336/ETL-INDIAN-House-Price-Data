...
def open_browser(url):
    ...
    for i in range(60):
        ...
        print(i)
        print("****************")
    with open("MB_Ghaziabad.html", "w", encoding="utf-8") as f:
...
def main():
    url = 'https://www.magicbricks.com/property-for-sale/residential-real-estate?bedroom=%3E5,1,2,3,4&proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Residential-House,Villa&cityName=Ghaziabad&BudgetMin=5-Lacs&BudgetMax=20-Crores'
    ...
    with open('MB_Ghaziabad.html', 'r', encoding='utf-8') as f:
        html = f.read()
    if html:
        soup = get_soup(html)
        cards = get_cards(soup)
        with open('MBHouse_Ghaziabad.csv', 'w', encoding='utf-8') as f:
